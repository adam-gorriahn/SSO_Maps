...
# For Render.com free tier (512MB), use 0.85-0.9 for aggressive memory reduction
# Default is now 0.85 (85% reduction) to fit within 512MB limit
MESH_DECIMATION_FACTOR = float(os.getenv('MESH_DECIMATION_FACTOR', '0.85'))
# Maximum number of faces for Garching mesh (0 = no limit)
# Default reduced to 30000 for 512MB environments
MAX_MESH_FACES = int(os.getenv('MAX_MESH_FACES', '30000'))
